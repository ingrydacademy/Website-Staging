...
export const metadata: Metadata = {
  ...
  description: "Discover our Java and Spring Boot course at Ingryd Academy. Get advanced Java training and Spring Boot expertise. Enhance your tech skills and career opportunities.",
};
