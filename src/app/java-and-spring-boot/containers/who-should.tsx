...
import imgHow from "@/assets/javaDown.png";
...
const HowTo = () => {
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-[#1D63FE] to-[#FF00F8] flex flex-col gap-6 py-16 px-8 overflow-x-hidden">
          ...
          <li className="lg:w-4/6 text-xl flex flex-col gap-6">
            <ul className="flex flex-col gap-6 text-white">
              ...
              <li className="flex gap-4 items-center">
                ...
                <p className="font-normal text-sm lg:text-xl">
                  Developers interested in creating cross-platform application
                  with java.
                </p>
              </li>
              <li className="flex gap-4 items-center">
                <ArrowRightIcon className="w-5 h-5 shrink-0 text-primary" />
                <p className="font-normal text-sm lg:text-xl">
                  Developers who want to strengthen their object-oriented
                  programming skills.
                </p>
              </li>
              <li className="flex gap-4 items-center">
                <ArrowRightIcon className="w-5 h-5 shrink-0 text-primary" />
                <p className="font-normal text-sm lg:text-xl">
                  Companies looking to empower their staff with the knowledge of
                  Java
                </p>
              </li>
            </ul>
