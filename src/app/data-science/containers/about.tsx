        ...
        <li className="grow lg:py-2 leading-7">
          <div className="md:text-center text-center text-base lg:text-xl font-normal text-[#1A183E]">
            <p>
              ...
              how to use Python programming language for data manipulation,
              cleaning, exploration, and analysis. The course also covers
              statistical analysis, machine learning algorithms, and data
          ...
          <div className="md:text-center text-center mt-8 text-base lg:text-xl font-normal text-[#1A183E]">
            <p>
              ...
              real-world problems. They will also be proficient in using popular
              Python libraries such as NumPy, Pandas, Matplotlib, and
              Scikit-learn.
            </p>
          </div>
        </li>
