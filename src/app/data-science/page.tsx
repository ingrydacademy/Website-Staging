...
export const metadata: Metadata = {
  ...
  description: "Join our Data Science with Python course at Ingryd Academy. Acquire advanced data science skills using Python. Unlock new career prospects in data analytics and beyond",
};
