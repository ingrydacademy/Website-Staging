        ...
        <section className="py-8 pb-32 lg:py-8 lg:px-16 lg:pb-32 px-6 flex flex-col-reverse lg:flex-row gap-10 items-center relative ">
                ...
                <ul className="grid grid-flow-row lg:grid-cols-2 lg:grid-rows-2 gap-8 px-0">
                    <li className="gap-6 text-xl text-white px-8 py-12 rounded-lg flex flex-col overflow-hidden relative">
                        ...
                        <div className="z-10 flex flex-col gap-4">
                            ...
                            <p className="text-sm lg:text-base text-gray-300">We employ a rigorous screening process to ensure that our talent pool includes only the best and meet qualified candidates</p>
                    ...
                    <li className="gap-6 text-xl text-white px-8 py-12 rounded-lg flex flex-col overflow-hidden relative">
                        ...
                        <div className="z-10 flex flex-col gap-4">
                            ...
                            <p className="text-sm lg:text-base text-gray-300">Our team is always available to provide guidance, support and expertise whenever you need it. </p>
                    ...
                    <li className="gap-6 text-xl text-white px-8 py-12 rounded-lg flex flex-col overflow-hidden relative">
                        ...
                        <div className="z-10 flex flex-col gap-4">
                            ...
                            <p className="text-sm lg:text-base text-gray-300">We invest in continuous learning and development opportunities for our talent to ensure that they have the skills to tackle complex technical challenges</p>
                    ...
                    <li className="gap-6 text-xl text-white px-8 py-12 rounded-lg flex flex-col overflow-hidden relative">
                        ...
                        <div className="z-10 flex flex-col gap-4">
                            ...
                            <p className="text-sm lg:text-base text-gray-300">We offer our clients competitive pricing without compromising on quality. We believe that our pricing model is straight forward, fair and transparent  </p>
            ...
            <div className=" flex flex-col gap-4 w-full lg:w-1/3">
                ...
                <p className="text-base lg:text-xl">
                    By offering quality tech talent innovation and competitive pricing, 
                    we stand out as a reliable and trustworthy partner for our clients
                </p>
            </div>
