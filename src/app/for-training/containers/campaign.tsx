        ...
        <section>
            <article className=' text-white flex flex-col gap-8 px-6 lg:px-16 py-16'>
                <div className='flex flex-col gap-6 bg-[#1A183E] rounded-xl py-5 lg:py-12 px-12 items-center'>
                    <h1 className='text-base lg:text-5xl text-center font-semibold'>Can’t afford a specific course?</h1>
                    <p className='text-xs lg:text-xl text-center lg:leading-9'>Go to the scholarship page to learn how you can take the course for free.</p>
