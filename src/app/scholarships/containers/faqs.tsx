                        ...
                        <Accordion type="single" collapsible className="w-full text-left flex flex-wrap gap-6 justify-between">
                            ...
                            <AccordionItem value="item-2" className="border-gray-300 w-full">
                                ...
                                <AccordionContent className="text-lg">
                                    ...
                                    Hybrid Learning: This style combines in-classroom and virtual classes. It includes 2 days
                                    of in-class lectures and 2 days of virtual classes per week, providing a balanced and
                                    interactive learning experience.
                                    Fully Virtual Learning: We also offer a remote experience for selected courses. You&apos;ll have
                    ...
                    <li className="lg:basis-1/2">
                        <Accordion type="single" collapsible className="w-full text-left flex flex-wrap gap-6 justify-between">
                            <AccordionItem value="item-7" className="border-gray-300 w-full">
                                ...
                                <AccordionContent className="text-lg">
                                    You can join our Scholarship Program, take the training for free and make payment after
                                    getting placed. To ensure qualification, applicants will be required to take and pass a pre
                                    assessment test to before gaining admission to the Scholarship Program.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-11" className="border-gray-300 w-full">
                                <AccordionTrigger className="hover:no-underline text-xl lg:text-2xl text-left">Are the hands-on-experience collaborative or individual?</AccordionTrigger>
                                <AccordionContent className="text-lg">
