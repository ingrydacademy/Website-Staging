...
export const metadata: Metadata = {
  ...
  description: "Join our DevOps course at Ingryd Academy. Receive advanced training and certification in DevOps practices. Enhance your tech career with DevOps expertise.",
};
