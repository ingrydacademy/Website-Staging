...
import imgHow from "@/assets/devops1.png";
          ...
          <li className="lg:w-4/6 text-xl flex flex-col gap-6">
            <ul className="flex flex-col gap-6 text-white">
              ...
              <li className="flex gap-4 items-center">
                ...
                <p className="font-normal text-sm lg:text-xl">
                  IT professionals and developers interested in streamlining
                  software development and IT operations processes.
                </p>
              </li>
              <li className="flex gap-4 items-center">
                <ArrowRightIcon className="w-5 h-5 shrink-0 text-primary" />
                <p className="font-normal text-sm lg:text-xl">
                  Individuals aiming to bridge the gap between development and
                  operations.
                </p>
              </li>
              <li className="flex gap-4 items-center">
