...
const Payment = () => {
  ...
  return (
    <section className="overflow-x-hidden py-14 px-8 flex flex-col lg:px-36 gap-8">
      ...
      <section className="grid gap-10 items-center md:grid-cols-2 place-content-center">
        <div className="w-[347px] h-[336px] lg:w-[500px] lg:h-[470px] rounded-md shadow-lg text-left p-5 lg:py-7">
          ...
          <div className="flex mt-4 gap-10 lg:gap-1">
            ...
            <p className="font-semibold">
              <span className="line-through font-normal">&#8358;250,000 </span>{" "}
              &#8358; 150,000
            </p>
          </div>
        </div>
        ...
        <div className="w-[347px] h-[336px] lg:w-[500px] lg:h-[470px] rounded-md shadow-lg text-left p-5 lg:py-7">
          ...
          <div className="flex mt-4 gap-10 lg:gap-1">
            ...
            <p className="font-semibold">
              <span className="line-through font-normal">&#8358;100,000 </span>
              &#8358; 60,000
            </p>
          </div>
          <div className="flex mt-4 gap-10 lg:gap-1">
            ...
            <p className="font-semibold">
              <span className="line-through font-normal">&#8358;75,000 </span>
              &#8358; 45,000
            </p>
          </div>
          <div className="flex mt-4 gap-10 lg:gap-1">
