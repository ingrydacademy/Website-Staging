...
const AboutProgram = () => {
  return (
    <section className="pt-40 pb-5 px-2 lg:px-48 flex flex-col gap-12 relative overflow-x-hidden">
      ...
      <div className="text-center">
        <h1 className="text-xl lg:text-3xl font-semibold">About this course</h1>
      </div>
      <ul className="flex flex-col-reverse gap-12 py-2 px-10">
        <li className="grow lg:py-2 leading-7">
          <div className="md:text-center text-center text-base lg:text-xl font-normal">
            <p>
          ...
          <div className="md:text-center text-center mt-8 text-base lg:text-xl font-normal">
            <p>
