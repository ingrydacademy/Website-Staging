        ...
        <section className="relative flex flex-col py-24 px-6 lg:px-24">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-start lg:items-center">
                    <Image src={logo} alt="image" className="aspect-square shrink-0 grow w-1/3 bg-[#15031D] lg:p-32 lg:hover:p-16 transition-all duration-300 object-contain" />
                    <ul className="flex flex-col gap-4 font-semibold list-disc pl-4 text-lg">
