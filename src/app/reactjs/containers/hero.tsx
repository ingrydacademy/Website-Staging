...
import ch3 from "@/assets/Rectangle 276.png";
    ...
    <section className="flex flex-col shrink-0 grow h-full min-h-screen relative">
      ...
      <div className="grid lg:grid-cols-3 shrink-0 grow h-full relative px-6 mx-auto">
        <div className="w-full h-full shrink-0 grow text-white lg:px-24 grid col-span-2 place-content-center gap-12 text-left">
          <h1 className="text-2xl lg:text-6xl font-semibold">React.js</h1>
          <p className="text-base lg:text-2xl md:w-[640px] h-[116px]">
            Get ready to take your web development skills to the next level with
            our comprehensive React course! Dive into the world of
            component-based architecture and learn how to build fast, scalable,
          ...
          <div className="flex lg:flex-row flex-col gap-4 items-center">
            ...
            <DownloadBronchure filePath="/assets/reactjs.pdf" fileName="reactjs.pdf"/>
          </div>
        </div>
