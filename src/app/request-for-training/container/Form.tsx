                    ...
                    <div className="flex gap-10">
                        <aside className="flex flex-col gap-5 w-1/2">
                            ...
                            <label className="flex flex-col gap-3">
                                ...
                                <input type="email" className="border-2 w-full h-14 rounded-lg px-2 border-[#BABABA] focus:bg-none" />
                            </label>
                            <label className="flex flex-col gap-3">
                                <p className="text-sm font-medium">
                        ...
                        <aside className="flex flex-col gap-5 w-1/2">
                            ...
                            <label className="flex flex-col gap-3">
                                ...
                                <input type="tel" className="border-2 w-full h-14 rounded-lg px-2 border-[#BABABA] focus:bg-none" />
                            </label>
                            <label className="flex flex-col gap-3">
                                <p className="text-sm font-medium">
