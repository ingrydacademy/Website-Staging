    ...
    <section className='flex flex-col gap-5 lg:gap-16 items-center text-secondary py-8 lg:py-20 px-12 text-center'>
            ...
            <ul className='flex flex-col lg:flex-row gap-5 lg:gap-8 w-full'>
                <li className='flex flex-col items-center gap-2 lg:gap-5 w-full py-5 px-10 lg:py-10 lg:px-14 rounded bg-white shadow-md'>
                        <figure className="flex rotate-45 mb-5 items-center justify-center bg-secondary rounded-md lg:rounded-xl text-semibold h-10 w-10 lg:h-28 lg:w-28">
                ...
                <li className='flex flex-col items-center gap-2 lg:gap-5 w-full py-5 px-10 lg:py-10 lg:px-8 rounded bg-white shadow-md'>
                        <figure className="flex rotate-45 mb-5 items-center justify-center bg-secondary rounded-md lg:rounded-xl text-semibold h-10 w-10 lg:h-28 lg:w-28">
