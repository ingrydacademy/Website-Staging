...
export const metadata: Metadata = {
  ...
  description: "Explore our IT Solution Sales course at Ingryd Academy. Acquire advanced skills in IT sales and unlock success in tech sales and business growth.",
};
