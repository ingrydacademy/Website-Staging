                    ...
                    <li className="lg:basis-1/2">
                        <Accordion type="single" collapsible className="w-full text-left flex flex-wrap gap-6 justify-between">
                            ...
                            <AccordionItem value="item-4" className="border-gray-300 w-full">
                                <AccordionTrigger className="hover:no-underline text-sm font-semibold lg:text-2xl text-left">What happens if I cannot afford to pay for training?</AccordionTrigger>
                                <AccordionContent className="text-xs lg:text-lg">
