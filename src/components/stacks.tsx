...
const CourseHighllight = () => {
  ...
  return (
    <>
      <h1 className="text-lg lg:text-4xl mt-5 text-center lg:mt-20 font-semibold">
        Stacks Available
      </h1>
            ...
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col justify-between gap-3 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Cybersecurity unlocks the door to job security. Protect
                  digital assets and explore global opportunities as a
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col justify-between gap-3 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Linux skills fuel diverse job opportunities. Embrace the world
                  of open-source software and take your career to a global scale
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col justify-between gap-3 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Unlock exciting job prospects in Java and Spring Boot. Elevate
                  your career with the expertise to develop high-performance
                  applications.
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-sm grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Data Science opens doors to dynamic job opportunities. Harness
                  the power of Python to drive data-driven decisions. Your
                  journey starts here.
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-sm grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  React.js offers promising job opportunities in web
                  development. Craft captivating user interfaces and seize
                  career possibilities in Nigeria's thriving tech sector and
                  beyond.
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-sm grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Node.js expertise paves the way for lucrative job prospects in
                  server-side development. Join the ranks of Node.js developers
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-1 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  DevOps opens up a world of opportunities. Bridge the gap
                  between development and operations, unlocking pathways to
                  modern software development careers
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-2 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  IT Sales is your gateway to a dynamic career. Explore the
                  realm of technology sales and unlock opportunities with
                  leading IT companies in Nigeria and beyond.
                </p>
          ...
          <SwiperSlide className="cursor-grab text-left select-none border border-gray-100 rounded-lg overflow-hidden shadow-lg p-5">
            <li className="flex flex-col justify-between w-full">
              ...
              <div className="flex flex-col gap-2 grow">
                ...
                <p className="text-sm lg:text-base text-left">
                  Product Management empowers your career journey. Gain the
                  skills to succeed and lead your way to thriving roles in
                  product management, strategy, and innovation
                </p>
