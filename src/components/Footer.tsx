  ...
  return (
    <footer className=" bg-[#1A183E] flex flex-col text-gray-200">
      <div className=" gap-8 container lg:px-30 lg:pt-20 pt-10 flex flex-col lg:flex-row justify-between flex-wrap w-full">
        <div className="flex flex-col gap-3 flex-1 lg:mr-32">
          ...
          <p className="text-primary underline underline-offset-4">
            <Link href="https://support@ingrydacademy.com">
        ...
        <div className="flex flex-col flex-1 gap-5">
          ...
          <nav className="list-none flex flex-col gap-3">
            ...
            <li>
              <Link href={"/request-staffing"} className=" hover:text-primary">
                Request Staffing
              </Link>
            </li>
            <li>
              <Link href={"/request-training"} className=" hover:text-primary">
                Request Training
              </Link>
            </li>
            <li>
              <Link href={"/for-training"} className=" hover:text-primary">
                Get Trained
              </Link>
            </li>
            <li>
      ...
      <div className="flex items-center justify-center my-5 lg:justify-start lg:my-2 gap-3 lg:pl-30 container">
        ...
        <a
          href="https://www.facebook.com/profile.php?id=100094777950769"
          target="_blank"
        >
